...
int main()
{
    ...
    const int data_count = DATA_COUNT * BATCH_SIZE; // 3*128*672
    int batch_num_ = BATCH_SIZE;    // 1
    int core_num_ = NUM_MULTICORE;  // 16
    ...
    CNRT_CHECK(cnrtInvokeKernel_V2((void *)&SBCKernel, dim, params, c, pQueue)); // 真正的执行
